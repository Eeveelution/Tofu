...
namespace Tofu.Bancho.Packets.Build282 {
    public class BanchoHandleOsuQuit : Serializable {
        ...
        public Packet ToPacket() => new(RequestType.BanchoHandleOsuQuit, this);

        public static BanchoHandleOsuQuit Create(ClientOsu clientOsu) {
            ...
            return new BanchoHandleOsuQuit {
                UserId          = clientOsu.Id,
        ...
        public static implicit operator Packet(BanchoHandleOsuQuit response) => response.ToPacket();
    }
}
